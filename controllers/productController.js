...
/**
 * 1. RENDER TRANG SẢN PHẨM (Load lần đầu)
 * Method: GET
 * URL: /products
 */
...
/**
 * 2. API LỌC & PHÂN TRANG (Dùng cho AJAX fetch)
 * Method: GET
 * URL: /products/filter
 */
exports.filterProducts = async (req, res) => {
    try {
        ...
        if (bikeTypes) {
            // Giả sử trong DB trường lưu loại xe là 'loaiXe' (dựa theo code cũ của bạn)
